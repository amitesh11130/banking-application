...
public class ResponseUtil {
    ...
    public static ApiResponse success(int code, Status status, String description, Object data) {
        return createResponse(code, description, status, data);
    }
    ...
    public static ApiResponse unAuthorized(int code, Status status, String description) {
        return createResponse(code, description, status, null);
    }
